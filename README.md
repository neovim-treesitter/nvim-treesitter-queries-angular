# nvim-treesitter-queries-angular

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-angular/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-angular/actions/workflows/validate.yml)

Neovim tree-sitter queries for **angular**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-angular",
...
- [ ] Changes are scoped to `angular` — do not include files for other languages
